...
\begin{figure}[height=3cm]
	...
	size 6in, 3in}]	
		...
		plot "../plots/05-Runtime-Seaside.data" using (cummulative_sum_a($3)):($1/1000) w p ls 2, \
		"../plots/05-Runtime-Seaside.data" using (cummulative_sum_b($3)):($1/1000) smooth bezier ls 1
	\end{gnuplot}
	\caption{Demoplot}
\end{figure}
