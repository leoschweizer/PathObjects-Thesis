...
Perscheid et al. already have shown that \emph{step-wise run-time analysis} maintains a low memory footprint during tracing \cite{perscheid_immediacy_2010}.
