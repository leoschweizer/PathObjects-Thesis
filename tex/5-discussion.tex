...
Figure \ref{fig:DiscussionStructure} depicts the basic components a \textsc{PathObjects} trace consists of in the form of a simplified class diagram.
...
\begin{figure}[b!]
	...
	\end{tikzpicture}
	\caption[TOC Caption]{Components of a \textsc{PathObjects} trace that contribute to the memory consumption.}
