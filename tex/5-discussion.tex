...
It shows the space consumption that is introduced through \textsc{PathObjects} in addition to the data that is collected through the underlying tracing framework \cite{perscheid_immediacy_2010}.
