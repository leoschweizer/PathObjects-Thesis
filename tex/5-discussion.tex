...
If a program under observation manipulates the call stack, for instance by using method wrappers itself, the assumptions made about the sequence of tracing framework calls will no longer hold true.
Consequently, the information that is gained during such tracing runs will be incorrect.
...
Therefore, the limitations that are introduced in conjunction with metaprogramming and reflection are acceptable.
