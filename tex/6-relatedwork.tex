...
\begin{figure}[b!]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
        %\includegraphics[width=\textwidth]{../images/foo}
...
\textsc{Blue} \cite{kolling_object-oriented_1996, kolling_blue_1996} and its adaption for Java called \textsc{BlueJ} \cite{kolling_bluej_2003} follow an alterantive approach to the teaching of the concepts of object orientation.
...
Although the user interface provides a dedicated area to display those instances, it does not actually visualize when two objects are interacting.
...
Moreno at al. present \textsc{Jeliot 3} which aims at teaching object oriented concepts to novice programmers with an interactive Java development environment \cite{moreno_visualizing_2004, bednarik_jeliot_2005}.
