...
One of the reasons that make program comprehension such a time-consuming activity is that it requires developers to bridge a gap of abstraction levels.
...
With the aid of a user study, we show that \textsc{PathObjects} actually can help developers to comprehend an unknown software system faster and to a higher degree in comparison to the Squeak standard development tools.
