...
Thereby, one does not even have to consider the lowest abstraction levels like logic gates CPU register values.
...
\section{Problem}\todo{Section Title}
...
\todo[inline]{nochmal significance}
...
In this work, we propose to tackle the two main problems identified above: first, traditional development tools tend to adapt the low level concepts of computers instead of adapting the high level concepts used during development.
