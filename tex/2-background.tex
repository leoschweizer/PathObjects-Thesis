...
For instance, many maintenance tasks like bug fixing, feature enhancement, refactoring, or documentation cannot be performed without having a satisfactory understanding of the system at hand.
...
They are not to be confused with cognitive models that describe how information is processed and how this contributes to the construction of a mental model.
...
With the help of empirical studies, she verified the existence of two different mental representations that are built during program comprehension.
...
Experiments have shown that this model typically emerges first, since participants tended to follow a bottom-up strategy.
...
Analogous to the observations about the program model, the domain model typically emerged later during program comprehension with successive analysis of a program.

Burkhardt et al. in turn have adapted Pennington's approach to the comprehension of object-programs \cite{burkhardt_mental_1997}.
...
At the same time, as stated in Section \ref{ss:BackgroundComprehensionDifficulties}, one of the main difficulties during program comprehension is attributable to the gab between the low-level abstraction levels of computers and the high-level abstraction levels of programming languages and design documents.
This would suggest that tools that aim at assisting program comprehension actually provide an information presentation that covers objects and their interactions.
...
Even when they are used to debug object-oriented programs, the information presentation of those debuggers is centered around the call stack.
...
A major reason might be that the analysis of object interactions necessarily imply the application of dynamic analysis techniques, which struggle from major problems themselves.
...
\todo[inline]{Finish other 2 diagrams}

\section{Challenges}
\todo[inline]{Summarize Problems}