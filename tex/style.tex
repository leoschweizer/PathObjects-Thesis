...
\lstdefinelanguage{JavaScript}{
  ...
  keywords={typeof, for, new, try, true, false, function, return, null, catch, switch, var, if, in, while, do, else, case, break,throw,this,debugger},
  keywordstyle=\color{black}\bfseries,
  classoffset=1,
  morekeywords={module, require, requires, exports, define, subclass, import, export, from},
  keywordstyle=\color{black}\bfseries\itshape,
  classoffset=0,
  moredelim=**[is][{\btHL\color{btFont}}]{@}{@},
  moredelim=**[is][{\btHL}]{@@}{@@},
  moredelim=**[is][{\btHL[fill=btBack3]}]{@@@}{@@@},
  moredelim=**[is][{\btHL[fill=btBack1, rounded corners=0pt, text width=\textwidth-5ex]}]{@[}{]@},
  moredelim=**[is][{\btHL[fill=btBack2, rounded corners=0pt, text width=\textwidth-5ex]}]{@@[}{]@@},
  moredelim=**[is][{\btHL[fill=btBack3, rounded corners=0pt]}]{@@@[}{]@@@},
  moredelim=**[is][\cursor\ignorespaces]{|@}{|},
  %identifierstyle=\large,
  sensitive=false,
  comment=[l]{//},
  morecomment=[s]{/*}{*/},
...
\lstnewenvironment{javascriptcolumn}[1][]{
	\lstset{language=JavaScript,frame=none,aboveskip=0pt,belowskip=0pt,#1}
	\xpfListingMode
	\minipage{0.375\linewidth}
}{
  \endminipage
	\xpfDefaultMode 
}
