...
However, this is an expensive operation in two respects.
First, a call of this method is time consuming and thus could slow down the tracing process significantly.
