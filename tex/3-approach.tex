...
In order to allow developers to focus on specific entities of interest, \textsc{PathObjects} allows for the filtering of irrelevant objects and messages.
...
\textsc{PathObjects} uses \textsc{PathView} to allow developers to define the messages that should be displayed.
