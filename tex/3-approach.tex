...
Consequently, edges should have as few bends as possible.
However, recent studies suggest that continuity is more important than the number of bends.

\paragraph{Length Minimization} Similar to crossings and bends, it becomes increasingly difficult 
