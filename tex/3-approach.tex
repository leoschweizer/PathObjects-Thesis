...
\section{Fundamental Diagram Notation}
...
When looking at the according source code, it can be seen that...\todo{blubb}
...
\begin{smalltalk}[caption={Foo}, label=lst:ApproachExample, escapechar=!]
