...
\label{c:approach}
This chapter presents \textsc{PathObjects}, an interactive diagramming concept which aims at assisting developers in object-oriented program comprehension.
