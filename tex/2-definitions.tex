...
Cognitive theory is ..., and consequently these models are not covered here.

The mental model approach originally has been developed in the context of text comprehension, for instance by van Dijk and Kintsch \cite{}, and has been adapted to procedural program comprehension by Pennington.
...
Experiments have shown that this model typically emerges first during program comprehension, since participants tended to follow a bottom-up strategy.
